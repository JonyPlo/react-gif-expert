...
describe('Pruebas en <AddCategory/>', () => {
  ...
  test('No debe de llamar a la funcion onNewCategory si el input esta vacio', () => {
    ...
    expect(onNewCategory).not.toHaveBeenCalled(); // Agregando .not delante de la segunda expresion podemos negar el resultado, viendolo desde javascript seria algo mas o menos como !true
  });
});
